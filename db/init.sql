...
-- Tạo bảng TournamentChessPlayer (bảng trung gian cho quan hệ N-N giữa Tournament và ChessPlayer)
CREATE TABLE TournamentChessPlayer
(
    id            VARCHAR(50) PRIMARY KEY,
    tournamentId  VARCHAR(50),
